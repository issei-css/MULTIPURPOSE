...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO fixed_interest_rates (term_months, interest_rate) VALUES (?, ?)");
...
// Get all rates
$rates = $conn->query("SELECT * FROM fixed_interest_rates ORDER BY term_months ASC");
?>
...
<head>
    ...
    <title>Fixed Interest Rates - Admin Dashboard</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="content">
        <!-- Top Bar -->
        <div class="top-bar">
            <div class="welcome">Fixed Deposit Interest Rates</div>
        ...
        <div class="form-card">
            <div class="form-title">Add New Interest Rate</div>
            <form method="POST">
        ...
        <!-- Defined Rates Table -->
        <div class="section-header">Defined Rates</div>
        <table class="data-table">
            ...
            <tbody>
                <?php $i = 1; while($row = $rates->fetch_assoc()): ?>
                    <tr>
                        <td><?php echo $i++; ?></td>
